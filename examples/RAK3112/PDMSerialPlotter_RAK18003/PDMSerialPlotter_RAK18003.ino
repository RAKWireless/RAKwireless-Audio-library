/**
   ...
   @note 
    ...
    2) This example need use the RAK18003 module.If using stereo, you need to use RAK18033 module and two PDM microphones.
   @version 0.1
   @date 2025-09-28
...
void loop() 
{
  ...
  samplesRead = samplesRead / 2;  //Each short data contains two Bytes
