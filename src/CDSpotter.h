#ifndef __CDSPOTTER_H__
#define __CDSPOTTER_H__
...
public:
	...
	unsigned char m_byaLicense[256];
	unsigned char m_nLicenseSize;
	...
	/* Set the active group while enter commands stage.
	 *   nGroupActive(in): Which commands gruop active. Start with 1.
	 * Return Success or negative value for error. */
	int SetActiveCommandGroup(int nGroupActive = 1);
